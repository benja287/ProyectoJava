...
|---|-------------|-------|------|-------|
| 1 | Portada | **Benjamín** | 0:30 | 0:30 |
| 2 | Integrantes | **Benjamín** | 1:00 | 1:30 |
| 3 | Separador — Bloque 1 | Lucas | 0:10 | 1:40 |
| 4 | El problema real | Lucas | 0:50 | 2:30 |
| 5 | Cómo nos acercamos | Lucas | 0:45 | 3:15 |
| 6 | Usuarios y adoptantes | Lucas | 0:45 | 4:00 |
| 7 | Separador — Bloque 2 | Benjamín | 0:05 | 4:05 |
| 8 | Línea de tiempo | **Benjamín** | 0:35 | 4:40 |
| 9 | Entrega 1 — Maquetado | Alcides | 0:45 | 5:25 |
| 10 | Entrega 2 — Modelo | **Benjamín** | 0:45 | 6:10 |
| 11 | Relaciones del modelo | **Benjamín** | 0:40 | 6:50 |
| 12 | Entrega 3 — Persistencia | **Benjamín** | 0:50 | 7:40 |
| 13 | Entrega 4 — REST | **Benjamín** | 0:55 | 8:35 |
| 14 | Sesión con JWT | Lucas | 0:40 | 9:15 |
| 15 | Entrega 5 — Angular | Alcides | 0:50 | 10:05 |
| 16 | Entrega 6 — Sistema completo | Alcides | 0:45 | 10:50 |
| 17 | Arquitectura | Lucas | 0:25 | 11:15 |
| 18 | Teoría aplicada | Lucas | 0:25 | 11:40 |
| 19 | Separador — Bloque 3 | Lucas | 0:05 | 11:45 |
| 20 | Reparto del grupo | Lucas | 0:55 | 12:40 |
| 21 | Herramientas y CI | Lucas | 1:00 | 13:40 |
| 22 | Separador — Bloque 4 | Alcides | 0:05 | 13:45 |
| 23 | **Demo en vivo** | Alcides | 4:00 | 17:45 |
| 24 | Dificultades | **Benjamín** | 0:55 | 18:40 |
| 25 | Aprendizajes | los tres (0:20 c/u) | 1:00 | 19:40 |
| 26 | Cierre | Lucas | 0:20 | 20:00 |

**Total por persona:** Benjamín **6:35** · Alcides **6:45** · Lucas **6:40**

> El PDF de la cátedra sugiere 8 minutos para el cierre. Nosotros usamos 4 de demo
> y 2:15 de balance, y dejamos el resto como colchón para preguntas o para que la demo
> se estire. Si la demo va fluida, extenderla; si algo falla, cortar en el paso 5 y
...
## Bloque 0 — Apertura (Benjamín, 1:30)

**Diapositiva 1 — Portada**

> Buenas tardes. Somos el Grupo 1 y vamos a contarles cómo construimos el sistema de
> gestión del V Congreso Argentino de Agroecología. No es una demo de pantallas: es el
> relato de seis entregas y de las decisiones que tomamos en cada una.

**Diapositiva 2 — Integrantes**

Presentar a los tres en una frase cada uno, decir de qué se ocupó cada uno en el
proyecto y anticipar el reparto de la charla. Cerrar con los números:

> Tres meses, seis entregas, 208 commits y unas 54.000 líneas entre Java y TypeScript.

---

## Bloque 1 — El problema (Lucas, 2:30)

**Diapositiva 3 — Separador.** Sólo leerla y avanzar.
...
**Diapositiva 5 — Cómo nos acercamos.**
...
**Diapositiva 6 — Usuarios y adoptantes.**
...
**Diapositiva 7 — Separador** (Benjamín).

**Diapositiva 8 — Línea de tiempo** (Benjamín, 0:35).
...
**Diapositiva 9 — Entrega 1** (Alcides, 0:45).
...
**Diapositiva 10 — Entrega 2** (Benjamín, 0:45).
...
**Diapositiva 11 — Relaciones del modelo** (Benjamín, 0:40).
...
**Diapositiva 12 — Entrega 3** (Benjamín, 0:50).
...
**Diapositiva 13 — Entrega 4** (Benjamín, 0:55).
...
**Diapositiva 15 — Entrega 5** (Alcides, 0:50).
Las cuatro dificultades son muy concretas; contarlas como anécdotas cortas.

**Diapositiva 16 — Entrega 6** (Alcides, 0:45).
...
**Diapositiva 17 — Arquitectura** (Lucas, 0:25). Recorrerla de arriba abajo, en una frase.

**Diapositiva 18 — Teoría aplicada** (Lucas, 0:25). No leerla. Decir:
...
**Diapositiva 19 — Separador.**

**Diapositiva 20 — Reparto.** El mensaje es el cambio de criterio:
...
**Diapositiva 21 — Herramientas y CI.** Mostrar la captura del pipeline.
...
**Diapositiva 22 — Separador.**
**Diapositiva 23 — Guion de la demo.** Mostrarla dos segundos y pasar al navegador.
...
**Diapositiva 24 — Dificultades** (Benjamín, 0:55). Elegir **dos** de las cinco y contarlas
bien; el resto queda en pantalla para quien quiera leerlo.

**Diapositiva 25 — Aprendizajes** (los tres, 20 segundos cada uno). Una tarjeta cada uno:
...
**Diapositiva 26 — Cierre** (Lucas, 0:20). Dejarla en pantalla durante las preguntas: tiene la URL de la app.
