        ...
        <div class="limpieza-grid">
          ...
          <div class="limpieza-bloque">
            <div class="limpieza-bloque-header">
              ...
              <a routerLink="/admin/notificaciones" class="btn-link">Ver listado completo →</a>
            </div>
            <p class="muted small">
              Avisos de la campanita guardados en la base (todos los usuarios). Podés listar,
              filtrar y borrar una por una o limpiar leídas/antiguas/todas.
              No afecta el historial de emails ni las plantillas.
            </p>
            <a routerLink="/admin/notificaciones" class="btn-secundario">Gestionar notificaciones</a>
          </div>
